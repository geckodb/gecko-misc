...
function executeQueriresWithoutCaching() {
    ...
    for(var loopcnt=0; loopcnt<100;loopcnt++){
        ...
        randomValArr=[5, 6, 10, 5, 9, 1, 5, 5, 8, 1,
            15, 12, 18, 10, 8, 12, 7, 16, 0, 13,
            17, 17, 5, 2, 3, 6, 13, 10, 7, 4,
            9, 14, 0, 14, 3, 1, 16, 8, 14, 4,
            16, 3, 10, 9, 5, 11, 4, 18, 17, 6,
            10, 17, 12, 17, 1, 10, 16, 11, 9, 18,
            16, 5, 12, 4, 11, 9, 16, 7, 1, 2,
            13, 18, 0, 0, 15, 7, 5, 13, 13, 7,
            8, 0, 10, 6, 11, 13, 10, 10, 8, 7,
            14, 11, 11, 7, 1, 11, 6, 11, 0, 18];

        arr=[3, 8, 4, 9, 4, 1, 5, 9, 4, 8, 1,
            3, 1, 10, 1, 4, 2, 7, 6, 7, 7, 2,
            9, 6, 9, 10, 1, 9, 1, 8, 1, 2, 2,
            5, 9, 2, 5, 4, 1, 10, 1, 10, 3, 7,
            1, 3, 5, 2, 4, 3, 10, 10, 10, 5,
            2, 8, 1, 5, 3, 9, 6, 10, 5, 5,
            10, 10, 10, 4, 5, 6, 3, 8, 9, 3,
            3, 2, 6, 3, 4, 2, 3, 5, 4, 4, 7,
            5, 1, 1, 3, 1, 1, 3, 2, 2, 6, 5,
            1, 5, 2, 7, 1, 1, 7, 9, 3, 7, 10,
            7, 9, 4, 10, 2, 7, 1, 4, 5, 4, 8,
            9, 6, 1, 1, 10, 6, 9, 1, 3, 1, 1,
            5, 10, 6, 9, 5, 1, 8, 6, 7, 8, 10,
            5, 9, 7, 1, 3, 4, 3, 2, 5, 7, 4, 7,
            1, 4, 5, 3, 7, 7, 4, 5, 8, 10, 4, 6,
            2, 9, 6, 4, 10, 4, 7, 6, 2, 8, 9, 7,
            5, 3, 2, 9, 3, 10, 6, 10, 9, 4, 10,
            5, 5, 2, 8, 7, 2, 1, 3, 9, 2, 5, 3,
            4, 9, 3, 10, 8, 1, 5, 6, 6, 2, 10,
            3, 8, 9, 3, 6, 4, 3, 6, 3, 2, 8, 6,
            7, 7, 7, 10, 8, 4, 8, 5, 8, 6, 3, 4,
            6, 1, 4, 10, 10, 5, 6, 8, 8, 5, 1, 2,
            4, 3, 9, 3, 3, 9, 2, 7, 3, 8, 4, 1, 3,
            10, 2, 5, 1, 7, 6, 8, 5, 2, 10, 4, 5,
            2, 5, 4, 6, 9, 1, 3, 4, 5, 1, 8, 1, 9,
            3, 4, 7, 10, 9, 7, 2, 2, 1, 7, 9, 4,
            5, 5, 8, 3, 7, 3, 3, 7, 5, 5, 4, 1,
            8, 7, 9, 10, 9, 5, 1, 4, 8, 7, 10,
            9, 7, 2, 6, 5, 8, 2, 4, 5, 9, 3, 2,
            4, 6, 1, 3, 9, 5, 2, 1, 10, 10, 2,
            4, 3, 1, 1, 4, 9, 9, 4, 8, 4, 4, 9,
            4, 7, 6, 8, 7, 10, 8, 4, 5, 8, 8,
            6, 9, 2, 5, 10, 3, 8, 9, 2, 1, 9,
            9, 4, 6, 5, 8, 5, 1, 3, 3, 2, 4, 4,
            8, 7, 9, 4, 3, 7, 10, 4, 8, 4, 5,
            10, 4, 4, 2, 2, 8, 7, 2, 3, 10, 6,
            10, 9, 2, 4, 4, 8, 4, 6, 5, 5, 7, 1,
            9, 10, 3, 10, 3, 5, 9, 10, 8, 1, 5,
            4, 1, 5, 1, 9, 10, 7, 4, 7, 3, 1, 7,
            6, 7, 6, 4, 4, 8, 3, 4, 4, 8, 6, 2,
            1, 10, 8, 8, 10, 7, 3, 2, 1, 1, 3,
            1, 10, 3, 4, 4, 8, 5, 3, 6, 1, 10, 7,
            10, 6, 7, 5, 6, 3, 3, 6, 5, 3, 7, 5,
            8, 6, 2, 6, 6, 2, 4, 9, 2, 9, 2, 5,
            6, 5, 4, 6, 3, 9, 6, 3, 4, 5, 6, 4,
            2, 8, 7, 10, 6, 1, 8, 3, 6, 10, 5,
            6, 2, 6, 2, 2, 3, 2, 5, 4, 5, 9, 9,
            8, 2, 10, 8, 3, 6, 4, 4, 6, 3, 7, 1,
            8, 8, 1, 9, 7, 5, 6, 8, 2, 4, 10, 5,
            9, 10, 3, 4, 1, 3, 2, 3, 1, 4, 10, 4,
            7, 4, 2, 8, 10, 10, 4, 2, 4, 3, 3, 1,
            7, 5, 4, 2, 7, 10, 10, 1, 8, 8, 4, 6,
            1, 2, 8, 10, 7, 1, 8, 4, 7, 8, 10, 8,
            6, 1, 1, 2, 10, 6, 8, 5, 7, 1, 2, 2,
            4, 6, 3, 2, 7, 2, 3, 10, 1, 4, 2, 3,
            3, 1, 10, 3, 5, 2, 1, 2, 9, 7, 1, 10,
            1, 5, 8, 5, 8, 7, 9, 4, 5, 6, 6, 7,
            8, 1, 5, 4, 6, 8, 8, 3, 4, 1, 10, 9,
            8, 2, 8, 1, 10, 4, 4, 4, 3, 10, 5, 1,
            8, 2, 7, 8, 4, 3, 8, 7, 2, 10, 10, 8,
            5, 1, 7, 10, 5, 6, 2, 8, 4, 1, 3, 4,
            1, 7, 4, 2, 1, 5, 4, 7, 5, 6, 8, 3,
            9, 10, 8, 10, 9, 2, 6, 3, 1, 3, 9,
            10, 2, 5, 4, 5, 1, 8, 5, 6, 9, 2,
            9, 5, 5, 2, 9, 3, 1, 6, 7, 8, 6, 3,
            10, 2, 9, 8, 3, 5, 3, 10, 7, 2, 4,
            5, 8, 9, 10, 1, 5, 5, 1, 2, 9, 10,
            7, 7, 5, 5, 2, 4, 10, 3, 2, 3, 5, 1,
            3, 9, 3, 5, 7, 7, 8, 1, 4, 8, 5, 4,
            9, 5, 7, 5, 4, 7, 2, 7, 3, 6, 6, 10,
            10, 10, 1, 6, 7, 7, 2, 3, 6, 4, 7, 3,
            1, 9, 8, 7, 6, 9, 5, 6, 1, 7, 2, 9, 4,
            9, 4, 2, 3, 3, 7, 8, 1, 7, 6, 5, 1, 3,
            8, 10, 5, 9, 3, 5, 4, 10, 8, 3, 3, 2, 8,
            6, 10, 3, 4, 6, 10, 1, 8, 2, 10, 7, 7, 10,
            1, 5, 7, 7, 3, 2, 4, 1, 2, 3, 8, 6, 6, 10,
            3, 3, 8, 6, 8, 7, 8, 8, 1, 1, 1, 2, 10, 1,
            1, 10, 8, 5, 10, 6, 4, 5, 3, 10, 2, 9, 2,
            10, 1, 8, 8, 9, 10, 10, 1, 8, 1, 3, 5, 10,
            3, 4, 3, 5, 8, 1, 10, 1, 1, 5, 6, 5, 7, 1,
            6, 9, 1, 4, 4, 9, 1, 8, 2, 4, 4, 5, 3, 9,
            4, 4, 5, 1, 10, 7, 5, 3, 5, 3, 5, 2, 5, 9,
            7, 1, 2, 5, 2, 10, 4, 2, 6, 2, 8, 3, 10,
            7, 2, 6, 9, 5, 5, 1, 7, 3, 9, 7, 4, 3, 9, 6, 6];
        arr2=[3, 23, 27, 29, 15, 27, 24, 6, 5, 19,
            13, 21, 23, 28, 8, 16, 16, 20, 28, 24,
            23, 10, 25, 4, 10, 7, 25, 5, 25, 1, 15,
            14, 25, 15, 13, 14, 20, 7, 1, 3, 12, 19,
            4, 28, 19, 9, 16, 17, 22, 8, 21, 25, 18,
            16, 18, 7, 1, 15, 0, 1, 0, 17, 17, 15, 18,
            25, 14, 23, 9, 28, 16, 25, 11, 8, 4, 27, 22,
            7, 9, 4, 12, 27, 16, 0, 14, 13, 17, 2, 5, 19,
            18, 18, 16, 15, 6, 26, 15, 7, 0, 10, 28, 13,
            25, 26, 21, 6, 29, 10, 24, 15, 21];
    ...
    document.getElementById("totalTimewocaching").innerText=Finaltime/100;
    var clearUrl="http://localhost:9200/dblpvertexes,dblprelation_authorship,dblprelation_citation,dblprelation_coauthorship,dblprelation_journalofpaper,dblprelation_venueofpaper/_cache/clear?request=true";
    $.ajax({
        dataType: "json",
        url: clearUrl,
...
function executeQueriresWithCaching() {
    ...
    document.getElementById("totalTimewcaching").innerText=Finaltime/100;
    var clearUrl="http://localhost:9200/dblpvertexes,dblprelation_authorship,dblprelation_citation,dblprelation_coauthorship,dblprelation_journalofpaper,dblprelation_venueofpaper/_cache/clear?request=true";
    $.ajax({
        dataType: "json",
        url: clearUrl,
...
function executeQueriresWithSelectedCaching() {
    ...
    document.getElementById("totalTimewSelectedcaching").innerText=Finaltime/100;
    var clearUrl="http://localhost:9200/dblpvertexes,dblprelation_authorship,dblprelation_citation,dblprelation_coauthorship,dblprelation_journalofpaper,dblprelation_venueofpaper/_cache/clear?request=true";
    $.ajax({
        dataType: "json",
        url: clearUrl,
