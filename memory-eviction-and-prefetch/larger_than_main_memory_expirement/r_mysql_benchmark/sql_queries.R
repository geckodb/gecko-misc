...
query_query_load_tables = paste (query_load_lineitem,query_load_orders,query_load_customer,query_load_partsupp,query_load_supplier,
	query_load_nation,query_load_region,query_load_part,sep=" ");
