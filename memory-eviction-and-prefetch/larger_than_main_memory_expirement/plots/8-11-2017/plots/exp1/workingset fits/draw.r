...
latency <- c(inno_csv$V2[1]/(60),inno_csv$V2[2]/(60),inno_csv$V2[3]/(60),inno_csv$V2[4]/(60),inno_csv$V2[5]/(60),inno_csv$V2[6]/(60),inno_csv$V2[7]/(60),memory_csv$V2/(60))
...
plot_ly(data, x = ~configurations, y = ~latency, type = 'bar', name = 'Latency in minutes') %>%
