...
query_create_lineitem_tiny ="
CREATE TABLE lineitem_tiny (
l_orderkey	INT	NOT NULL, 
l_partkey	INT	NOT NULL, 
l_suppkey	INT	NOT NULL, 
l_linenumber	INT	NOT NULL, 
...
query_drop_lineitem_tiny = "drop table lineitem_tiny;";
...
query_load_lineitem_tiny = paste("LOAD DATA LOCAL INFILE '",path_to_tables,current_scale_factor,"/lineitem_tiny.tbl'  INTO TABLE lineitem_tiny FIELDS TERMINATED BY '|';",sep="");
