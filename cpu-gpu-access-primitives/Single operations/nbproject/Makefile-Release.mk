...
${OBJECTDIR}/Column_Store_Import_methods.o: Column_Store_Import_methods.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Column_Store_Import_methods.o Column_Store_Import_methods.cpp

${OBJECTDIR}/OpenCLExecutionColumnStore.o: OpenCLExecutionColumnStore.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/OpenCLExecutionColumnStore.o OpenCLExecutionColumnStore.cpp

${OBJECTDIR}/OpenCLExecutionRowStore.o: OpenCLExecutionRowStore.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/OpenCLExecutionRowStore.o OpenCLExecutionRowStore.cpp

${OBJECTDIR}/QueryDataGenerator.o: QueryDataGenerator.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/QueryDataGenerator.o QueryDataGenerator.cpp

${OBJECTDIR}/Row_Store_Data.o: Row_Store_Data.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Row_Store_Data.o Row_Store_Data.cpp

${OBJECTDIR}/Row_Store_Import_Methods.o: Row_Store_Import_Methods.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Row_Store_Import_Methods.o Row_Store_Import_Methods.cpp
